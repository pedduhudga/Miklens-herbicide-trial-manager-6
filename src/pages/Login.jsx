            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-500 hover:text-slate-300 transition-colors focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-r-2xl outline-none"
        ...
        <div className="fixed inset-0 z-[21000] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-[fadeIn_0.2s_ease-out]">
          <div className="bg-[#0b1329] border border-white/10 rounded-[32px] shadow-2xl w-full max-w-md p-6 space-y-4 relative animate-[modalPopIn_0.3s_ease-out]">
            <button
              ...
              className="absolute right-4 top-4 p-1.5 hover:bg-white/5 rounded-xl text-slate-400 hover:text-slate-200 transition-colors focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
