...
export const CATEGORIES = {
  ...
  nutrition: {
    ...
    observationFields: [
      ...
      { key: 'leafNitrogenPct', label: 'Leaf Nitrogen Content (%)', type: 'number', min: 0, max: 20 },
      { key: 'leafPhosphorusPct', label: 'Leaf Phosphorus Content (%)', type: 'number', min: 0, max: 10 },
      { key: 'leafPotassiumPct', label: 'Leaf Potassium Content (%)', type: 'number', min: 0, max: 10 },
  ...
  biostimulant: {
    ...
    observationFields: [
      ...
      { key: 'ndvi', label: 'NDVI Index', type: 'number', min: 0, max: 1 },
