...
export const CATEGORIES = {
  ...
  nutrition: {
    ...
    aiPhotoPrompt: 'Act as an expert crop nutritionist and agronomist. Analyze this nutrition trial plot photo to evaluate crop health, plant vigor, and nutrient status. Inspect leaf color and structure for chlorosis, necrosis, or specific nutrient deficiency symptoms (e.g., Nitrogen, Phosphorus, Potassium, Zinc, Iron). To prevent hallucinations, only report deficiency symptoms that are clearly manifest and visually undeniable on the plant leaves. Estimate growth parameters (plant height, leaf/tiller count) using strict visual cues. If a symptom is ambiguous, do not assume a deficiency.',
